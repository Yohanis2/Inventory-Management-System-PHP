...
// Fetch all approved requests from the database for further processing by College Dean
$sql = "SELECT * FROM request WHERE status = 'Approved by Head' ORDER BY req_date DESC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($request_id && ($action == 'approve' || $action == 'reject')) {
        ...
        $new_status = ($action == 'approve') ? 'Approved by Dean' : 'Rejected by Dean';
...
<main id="main-content" class="container-fluid mt-5 pt-3">
    <div class="row">
        ...
        <aside class="col-md-3 sidebar-left">
            <h2><a href="college_dean.php" class="home text-decoration-none"><i class="fa fa-home"></i>
            College Dean</a></h2>
            <nav class="d-flex flex-column">
                <a href="pending_collage.php" class="btn btn-link">Pending Requests   <i class="fas fa-bell"></i></a>
        ...
        <section class="col-md-6">
            <h1>Pending Requests (Approved by Head)</h1>
