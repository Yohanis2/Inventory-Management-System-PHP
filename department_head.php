...
$count_sql = "SELECT COUNT(*) AS unread_count FROM request WHERE status = 'Pending'";
        ...
        <div class="row">
            <aside class="col-md-3 sidebar-left">
                ...
                <nav class="d-flex flex-column">
                    <div class="dropdown">
                        <a href="pending_dep.php" class="btn btn-link" title="Notifications" onclick="toggleDropdown('notificationMenu')">
            ...
            <div class="main">
    <h1><i class="fas fa-tachometer-alt"></i> Welcome to the Department Head Dashboard</h1>
