...
// Fetch count of pending requests for the logged-in employee
$count_sql = "SELECT COUNT(*) AS unread_count FROM request WHERE Emp_id = ? AND status IN ('Completed', 'Pending')";
$count_stmt = mysqli_prepare($conn, $count_sql);
mysqli_stmt_bind_param($count_stmt, 's', $emp_id); // Bind the Emp_id
        ...
        <aside class="col-md-3 sidebar-left">
            <h2><a href="staff.php" class="home text-decoration-none"><i class="fa fa-home"></i>
                ...
                <nav class="d-flex flex-column">
                    <div class="dropdown">
                        <a href="Recive_Response.php" class="btn btn-link" title="Notifications" onclick="toggleDropdown('notificationMenu')">
                        Recive Response <i class="fas fa-bell"></i>
            ...
            <div class="main">
    <h1><i class="fas fa-tachometer-alt"></i> Welcome to the Staff Dashboard</h1>
