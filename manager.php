...
$count_sql = "SELECT COUNT(*) AS unread_count FROM request WHERE status = 'Approved by President'";
    ...
    <main id="main-content" class="container-fluid mt-5 pt-3">
        <div class="row">
            <aside class="col-md-3 sidebar-left">
                <h2><a href="manager.php" class="home text-decoration-none"><i class="fa fa-home"></i>
                Manager</a></h2>
                <nav class="d-flex flex-column">
                    <div class="dropdown">
                        <a href="pending_manager.php" class="btn btn-link" title="Notifications" onclick="toggleDropdown('notificationMenu')">
